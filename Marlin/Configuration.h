...
#define STRING_CONFIG_H_AUTHOR "(Justin Federico, modded config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Fender-3 V1"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -51, -13, 0 }
 ...
 */
#define Z_SAFE_HOMING // Needed for use with my BLTouch
